...
CREATE TABLE IF NOT EXISTS historial (
  ...
  ganador_1_puntos INT  NOT NULL DEFAULT 0,
  ganador_1_premio TEXT NOT NULL DEFAULT '',
  ganador_2   TEXT NOT NULL DEFAULT '',
  ganador_2_puntos INT  NOT NULL DEFAULT 0,
  ganador_2_premio TEXT NOT NULL DEFAULT '',
  ganador_3   TEXT NOT NULL DEFAULT '',
  ganador_3_puntos INT  NOT NULL DEFAULT 0,
  ganador_3_premio TEXT NOT NULL DEFAULT '',
